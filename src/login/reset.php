...
<body>
	...
	<p> Enter your username or email-id and <br>we will send you one time password to reset<br> your password</p><br><br>
	<div id="mydiv">
	<input id="inputfield" type="text" placeholder="Username or E-Mail"><br><br>
	<input id="inputfield2" type="text" placeholder="OTP(One Time Password)"><br><br>
